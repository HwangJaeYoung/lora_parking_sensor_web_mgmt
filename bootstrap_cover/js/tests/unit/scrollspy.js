$(function () {
  ...
  QUnit.test('should only switch "active" class on current target', function (assert) {
    ...
    var sectionHTML = '<div id="root" class="active">' +
        ...
        '</div>' +
        '</div>' +
        '<div id="scrollspy-example" styles="height: 100px; overflow: auto;">' +
  ...
  QUnit.test('should correctly select middle navigation option when large offset is used', function (assert) {
    ...
    var sectionHTML = '<div id="header" styles="height: 500px;"></div>' +
        ...
        '</ul>' +
        '</nav>' +
        '<div id="content" styles="height: 200px; overflow-y: auto;">' +
        '<div id="one" styles="height: 500px;"></div>' +
        '<div id="two" styles="height: 300px;"></div>' +
        '<div id="three" styles="height: 10px;"></div>' +
        '</div>'
    var $section = $(sectionHTML).appendTo('#qunit-fixture')
    var $scrollspy = $section
      .show()
  ...
  QUnit.test('should add the active class to the correct element', function (assert) {
    ...
    var navbarHtml =
      ...
      '</nav>'
    var contentHtml =
        '<div class="content" styles="overflow: auto; height: 50px">' +
      '<div id="div-1" styles="height: 100px; padding: 0; margin: 0">div 1</div>' +
      '<div id="div-2" styles="height: 200px; padding: 0; margin: 0">div 2</div>' +
      '</div>'
  ...
  QUnit.test('should add the active class correctly when there are nested elements at 0 scroll offset', function (assert) {
    ...
    var contentHtml = '<div class="content" styles="position: absolute; top: 0px; overflow: auto; height: 50px">' +
      '<div id="div-1" styles="padding: 0; margin: 0">' +
      '<div id="div-2" styles="height: 200px; padding: 0; margin: 0">div 2</div>' +
      '</div>' +
      '</div>'
  ...
  QUnit.test('should clear selection if above the first section', function (assert) {
    ...
    var scrollspyHTML = '<div id="content" styles="height: 200px; overflow-y: auto;">' +
        '<div id="spacer" styles="height: 100px;"/>' +
        '<div id="one" styles="height: 100px;"/>' +
        '<div id="two" styles="height: 100px;"/>' +
        '<div id="three" styles="height: 100px;"/>' +
        '<div id="spacer" styles="height: 100px;"/>' +
        '</div>'
  ...
  QUnit.test('should correctly select navigation element on backward scrolling when each target section height is 100%', function (assert) {
    ...
    var navbarHtml =
      ...
      '</nav>'
    var contentHtml =
        '<div class="content" styles="position: relative; overflow: auto; height: 100px">' +
      '<div id="div-100-1" styles="position: relative; height: 100%; padding: 0; margin: 0">div 1</div>' +
      '<div id="div-100-2" styles="position: relative; height: 100%; padding: 0; margin: 0">div 2</div>' +
      '<div id="div-100-3" styles="position: relative; height: 100%; padding: 0; margin: 0">div 3</div>' +
      '<div id="div-100-4" styles="position: relative; height: 100%; padding: 0; margin: 0">div 4</div>' +
      '<div id="div-100-5" styles="position: relative; height: 100%; padding: 0; margin: 0">div 5</div>' +
      '</div>'
  ...
  QUnit.test('should allow passed in option offset method: offset', function (assert) {
    ...
    var testOffsetMethod = function (type) {
      ...
      var $content = $(
        '<div class="content"' + (type === 'data' ? ' data-spy="scroll" data-target="#navbar-offset-method-menu" data-offset="0" data-method="offset"' : '') + ' styles="position: relative; overflow: auto; height: 100px">' +
        '<div id="div-' + type + 'm-1" styles="position: relative; height: 200px; padding: 0; margin: 0">div 1</div>' +
        '<div id="div-' + type + 'm-2" styles="position: relative; height: 150px; padding: 0; margin: 0">div 2</div>' +
        '<div id="div-' + type + 'm-3" styles="position: relative; height: 250px; padding: 0; margin: 0">div 3</div>' +
        '</div>'
      )
  ...
  QUnit.test('should allow passed in option offset method: position', function (assert) {
    ...
    var testOffsetMethod = function (type) {
      ...
      var $content = $(
        '<div class="content"' + (type === 'data' ? ' data-spy="scroll" data-target="#navbar-offset-method-menu" data-offset="0" data-method="position"' : '') + ' styles="position: relative; overflow: auto; height: 100px">' +
        '<div id="div-' + type + 'm-1" styles="position: relative; height: 200px; padding: 0; margin: 0">div 1</div>' +
        '<div id="div-' + type + 'm-2" styles="position: relative; height: 150px; padding: 0; margin: 0">div 2</div>' +
        '<div id="div-' + type + 'm-3" styles="position: relative; height: 250px; padding: 0; margin: 0">div 3</div>' +
        '</div>'
