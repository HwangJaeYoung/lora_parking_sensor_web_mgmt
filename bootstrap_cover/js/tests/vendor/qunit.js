...
(function (global$1) {
  ...
  (function () {
  	...
  	function toolbarModuleFilter() {
  		...
  		actions.innerHTML = "<button styles='display:none'>Apply</button>" + "<button type='reset' styles='display:none'>Reset</button>" + "<label class='clickable" + (config.moduleId.length ? "" : " checked") + "'><input type='checkbox'" + (config.moduleId.length ? "" : " checked='checked'") + ">All modules</label>";
